...
DevId = Config.DevId
SudoIds = {Config.SudoIds,2140356312,2140356312}
DevTwix = Config.DevTwix
TokenBot = Config.TokenBot
NameBot = (DevHmD:get(DevTwix..'HmD:NameBot') or 'سيزر')
---------------------------------------------------------------------------------------------------------
...
os.execute('wget https://raw.githubusercontent.com/Sajjad31310/s_313_10/main/DevTwix.lua')
dofile('DevTwix.lua')
...
keyboard = {}
keyboard.inline_keyboard = {
{{text="⌁ السورس ˛",url="https://t.me/sourcesezar"},{text="⌁ المطور ˛",url="t.me/"..(dp.username_ or "sourcesezar")},},
...
◇︰موال • رقمي • لقبي • نبذتي • صلاحياتي • غنيلي
...
if text and text:match('^'..(DevHmD:get(DevTwix..'HmD:NameBot') or "سيزر")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevHmD:get(DevTwix..'HmD:NameBot') or "سيزر")..' ','')
end
...
keyboard = {}
keyboard.inline_keyboard = {{{text = 'معرفة المزيد ؟',url="https://t.me/"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sourcesezar/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text and text:match("^الغاء$") then
DevHmD:del('DevSezarTeam:'..DevTwix..'id:user'..msg.chat_id_)
Dev_HmD(msg.chat_id_, msg.id_, 1, '◇︰تم الغاء الامر', 1, 'md')
DevHmD:del('DevSezarTeam:'..DevTwix.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)
return false  end
DevHmD:del('DevSezarTeam:'..DevTwix.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)
local numadded = string.match(text, "(%d+)")
local iduserr = DevHmD:get('DevSezarTeam:'..DevTwix..'id:user'..msg.chat_id_)
...
if text and Constructor(msg) then
if DevHmD:get('DevSezarTeam:'..DevTwix.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then
DevHmD:del('DevSezarTeam:'..DevTwix..'ids:user'..msg.chat_id_)
Dev_HmD(msg.chat_id_, msg.id_, 1, '◇︰تم الغاء الامر', 1, 'md')
DevHmD:del('DevSezarTeam:'..DevTwix.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)
return false  end
DevHmD:del('DevSezarTeam:'..DevTwix.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)
local numadded = string.match(text, "(%d+)")
local iduserr = DevHmD:get('DevSezarTeam:'..DevTwix..'ids:user'..msg.chat_id_)
...
local BotName = (DevHmD:get(DevTwix.."HmD:NameBot") or 'سيزر')
...
if text and text == (DevHmD:get(DevTwix..'HmD:NameBot') or 'سيزر') then
NameBot = (DevHmD:get(DevTwix..'HmD:NameBot') or 'سيزر')
...
local texting = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","??","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗","📂","📅","📪","📫","📬","📭","⏰","📺","🎚","☎️","📡"};
DevTwixTeam = texting[math.random(#texting)],'md'
Dev_HmD(msg.chat_id_, msg.id_, 1,DevTwixTeam, 1, 'md')
end
...
if text == 'حروف' and ChCheck(msg) or text == 'الاحرف' and ChCheck(msg) then
local texting1 = {" جماد بحرف ⇦ ر  ",
" مدينة بحرف ⇦ ع  ",
" حيوان ونبات بحرف ⇦ خ  ",
" اسم بحرف ⇦ ح  ",
" اسم ونبات بحرف ⇦ م  ",
...
DevTwixTeam = texting1[math.random(#texting1)],'md'
Dev_HmD(msg.chat_id_, msg.id_, 1,DevTwixTeam, 1, 'md')
end
if text == 'كت' and ChCheck(msg) or text == 'كت تويت' and ChCheck(msg) then
...
if text == 'خيرني' and ChCheck(msg) or text == 'لو خيروك' and ChCheck(msg) then
...
Dev_HmD(msg.chat_id_, msg.id_, 1, '◇︰حسنا قم باعادة توجيه للمنشور الذي تريدني حساب مشاهداته', 1, 'md')
 ...
 ---------------------------------------------------------------------------------------------------------
if text and (text == 'سورس' or text == 'السورس' or text == 'يا سورس') then
local msg_id = msg.id_/2097152/0.5
Text = [[
*Welcome To Source*
...
keyboard = {}
keyboard.inline_keyboard = {
{{text = '• Dev -› AliAbbas95 •',url="t.me/Aliabbas95"}},}
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=t.me/sourcesezar&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
---------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------
if text == "هلو" and ChCheck(msg) or text == "هلا" and ChCheck(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1, '◇︰هلا ب'..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'html') end
...
---------------------------------------------------------------------------------------------------------
if text == "هلو" and ChCheck(msg) or text == "هلا" and ChCheck(msg) then Dev_HmD(msg.chat_id_, msg.id_, 1, '◇︰هلا ب'..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'html') end
---------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------
if text == ("شنو رئيك بهذا") or text == ("شنو رايك بهاذ") or text == ("شنو رئيك بهاذ") or text == ("شنو رأيك بهذا") or text == ("شنو رايك بهذا") then
local HmD1 = {"ادب سسز يباوع علي بنات ??🥺"," مو خوش ولد 😶","زاحف وما احبه 😾😹","اهم شي عنده البنات"}
...
if text == ("شنو رئيك بهاي") or text == ("شنو رايك بهاي") or text == ("شنو رئيك بهايه") or text == ("شنو رايك بهايه") then
local HmD2 = {"ماعرف شكلك بس هاي بومه 🙃","ختولي ماحترمها 😂😂","خوش بنيه حبابه 😙😍","افف هاي عافيتي احبها 🥰","زاحفهه ام الولد هاي 😐"}
...
keyboard = {}
keyboard.inline_keyboard = {
{{text = ''..GetCustomTitle(result.sender_user_id_,msg.chat_id_)..'' ,url="https://t.me/sourcesezar"}},
...
keyboard = {}
keyboard.inline_keyboard = {
{{text = ''..GetCustomTitle(msg.sender_user_id_,msg.chat_id_)..'' ,url="https://t.me/sourcesezar"}},
...
if text == 'نبذتي' and ChCheck(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1, '◇︰نبذتك -› '..GetBio(msg.sender_user_id_, msg.chat_id_), 1, 'html')
end
---------------------------------------------------------------------------------------------------------
if Admin(msg) then
...
T = {}
T.inline_keyboard = {{{text = "لقبة -› "..CustomTitle.." ", url="https://t.me/sourcesezar"},},}
Msg_id = msg.id_/2097152/0.5
...
L = {}
L.inline_keyboard = {{{text = "لقبة -› "..CustomTitle.." ", url="https://t.me/sourcesezar"},},}
Msg_id = msg.id_/2097152/0.5
...
DevHmD:set("DevTwix:New:id:"..DevTwix..msg.sender_user_id_,'DevSezarTeam')
return "DevTwixTeam"
end
...
Dev_HmD(msg.chat_id_, msg.id_, 1, '\n*◇︰ارسل الان النص \n\n◇︰يمكنك اضافه التالي  :*\n\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#photos` > عدد صور المستخدم\n- `#id` > ايدي المستخدم\n- `#auto` > تفاعل المستخدم\n- `#stast` > موقع المستخدم\n- `#bio` > بايو المستخدم\n- `#edit` > عدد السحكات\n- `#game` > المجوهرات\n- `#AddMem` > عدد الجهات\n- `#CustomTitle` > لطبع القب\n- `#Description` > تعليق الصوره\n* ••••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉•••• \n- قناة كلايش تعين الايدي : @Gverr*', 1, 'md')
DevHmD:set("DevTwix:New:id:"..DevTwix..msg.chat_id_..msg.sender_user_id_,'DevSezarTeam')
return "DevSezarTeam"
end
...
if text and text:match("^فتح التفليش$") and ChCheck(msg) or text and text:match("^تعطيل الحمايه القصوى$") and ChCheck(msg) then
if not Constructor(msg) then
Dev_HmD(msg.chat_id_, msg.id_, 1, '◇︰للمنشئين فقط', 1, 'md')
else
DevHmD:hdel(DevTwix.."HmD:Spam:Group:User"..msg.chat_id_ ,"Spam:User")
...
{{text = "برج القوس",callback_data=msg.sender_user_id_.."Getprjالقوس"},{text ="برج العقرب",callback_data=msg.sender_user_id_.."Getprjالعقرب"},{text ="برج الميزان",callback_data=msg.sender_user_id_.."Getprjالميزان"}},
{{text = "برج الحوت",callback_data=msg.sender_user_id_.."Getprjالحوت"},{text ="برج الدلو",callback_data=msg.sender_user_id_.."Getprjالدلو"},{text ="برج الجدي",callback_data=msg.sender_user_id_.."Getprjالجدي"}},
{{text = '< DevSezarTeam .',url="t.me/sourcesezar"}},}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
if text and (text == "غنيلي" or text == "غ") and not DevHmD:get(DevTwix..'HmD:Remix:HmD'..msg.chat_id_) and ChCheck(msg) then
HmD = math.random(2,32);
local Text ='*: الاغنيه ، حِسب ذۅقيّ ❤️‍🔥، .*'
keyboard = {}
keyboard.inline_keyboard = {{{text = '< DevSezarTeam .',url="t.me/sourcesezar"}},}
local msg_id = msg.id_/2097152/0.5
...
if text and (text == "شعر" or text == "ش") and not DevHmD:get(DevTwix..'HmD:Remix:HmD'..msg.chat_id_) and ChCheck(msg) then
HmD = math.random(2,32);
local Text ='*: الشعر ، حِسب ذۅقيّ ❤️‍🔥، .*'
keyboard = {}
keyboard.inline_keyboard = {{{text = '< DevSezarTeam .',url="t.me/sourcesezar"}},}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {{{text = '< DevSezarTeam .',url="t.me/sourcesezar"}},}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/Sadyouf4/'..HmD..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
...
keyboard = {}
keyboard.inline_keyboard = {
{{text = ''..sendLove..'' ,url="https://t.me/sourcesezar"}},
...
keyboard = {}
keyboard.inline_keyboard = {
{{text = ''..sendubmj..'' ,url="https://t.me/sourcesezar"}},
{{text="◈ آخفاء النسبة ◈",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
DevHmD:del(DevTwix..'JNsba:HmD'..msg.chat_id_..msg.sender_user_id_)
...
keyboard = {}
keyboard.inline_keyboard = {
{{text = ''..sendnmj..' .' ,url="https://t.me/sourcesezar"}},
...
◇︰كشف الارتباط
 ••••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••••
◇︰Channel ~> @DevSezarTeam*
]]
keyboard = {}
keyboard.inline_keyboard = {{{text="{ قائمة آلاوآمر }",callback_data="/HelpList:"..msg.sender_user_id_}},
{{text="< DevSezarTeam .",url="t.me/sourcesezar"}},{{text="◈ آخفاء الكليشة ◈",callback_data="/HideHelpList:"..msg.sender_user_id_}}}
Msg_id = msg.id_/2097152/0.5
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Help or Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
---------------------------------------------------------------------------------------------------------
if text == text == "تحديث السورس" and SourceCh(msg) or text == "تحديث الملفات" and SourceCh(msg) then
local Help = DevHmD:get(DevTwix..'HmD:Help')
if not SecondSudo(msg) then
...
------------------------------------------------------------------------------------------------------------
if SecondSudo(msg) then
if text == "تحديث سيزر" and ChCheck(msg) or text == "تحديث سورس سيزر" and ChCheck(msg) or text == "تحديث" and ChCheck(msg)or text == "× تحديث السورس ×" and ChCheck(msg) then
...
DevHmD:set(DevTwix..'HmD:NameBot',(DevHmD:get(DevTwix..'Name:Bot') or 'سيزر'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
*◇︰ Channel -› *[Files Sezar ](https://t.me/sourcesezar)

*◇︰ Me -› *[TwsL Sezar](https://t.me/Aliabbas95)
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '• Dev -› Ali •',url="t.me/Aliabbas95"}},}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=T.ME/sourcesezar/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
 ---------------------------------------------------------------------------------------------------------
if text and (text == 'المبرمج' or text == 'مبرمج السورس' or text == 'مبرمج') then
local msg_id = msg.id_/2097152/0.5
Text = [[*◇︰مبرمج السورس -›@Aliabbas95*]]
keyboard = {}
