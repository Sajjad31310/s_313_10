...
local msg_id = msg.id_/2097152/0.55
https.request("https://api.telegram.org/bot"..TokenBot.."/sendphoto?chat_id=" .. msg_chat_id_ .. "&photo="..photo.."&caption=".. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
