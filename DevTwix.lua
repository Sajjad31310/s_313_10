...
LockList ={'HmD:Lock:Links','HmD:Lock:Contact','HmD:Lock:Forwards','HmD:Lock:Videos','HmD:Lock:Gifs','HmD:Lock:EditMsgs','HmD:Lock:Stickers','HmD:Lock:Farsi','HmD:Lock:Spam','HmD:Lock:Photo'}
for i,Lock in pairs(LockList) do
...
------------------------------------------------------------------------------------------------------------
if SecondSudo(msg) then
if text == "تحديث سيزر" and ChCheck(msg) or text == "تحديث سورس سيزر" and ChCheck(msg) or text == "تحديث" and ChCheck(msg) then
