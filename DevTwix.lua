...
DevTwixTeam(msg.chat_id_, msg.id_,"• اسرع واحد يرسل هاذا السمايل ?  `"..SM.."`")
return false
end
end
DevTwixTeam = '◇︰اول واحد يدز هذا السمايل يربح -› ['..SM..']'
...
Dev_HmD(msg.chat_id_, msg.id_, 1,DevTwixTeam, 1, 'md')
DevHmD:incrby(DevTwix..'HmD:GamesNumber0'..msg.chat_id_..msg.sender_user_id_, 1)
end
