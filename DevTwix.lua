...
data,res = https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/TEAMSUL/'..HmD..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown")
if res == 200 then
...
keyboard = {}  
keyboard.inline_keyboard = {{{text = '‏'..SendPoetr..'',url="t.me/sourcesezar"}},}
local msg_id = msg.id_/2097152/0.5
