...
keyboard = {} 
keyboard.inline_keyboard = {
{{text="⌁ السورس ˛",url="https://t.me/sourcesezar"},{text="⌁ المطور ˛",url="t.me/"..(dp.username_ or "DevTwix")},},
{{text="⌁ آضغط لاضافتي ˛",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
*◇︰TeAm -› *[DevTwiX](https://t.me/sourcesezar)

*◇︰ Channel -› *[Files Sezar ](https://t.me/sourcesezar)

*◇︰ Bot -› *[DevSezarTeam](https://t.me/AliAbbas95)
]]
keyboard = {}
keyboard.inline_keyboard = {
...
------------------------------------------------------------------------------------------------------------
if SecondSudo(msg) then
if text == "تحديث سيزر" and ChCheck(msg) or text == "تحديث سورس سيزر" and ChCheck(msg) or text == "× تحديث السورس ×" and ChCheck(msg) then
...
Text = [[*◇︰مبرمج السورس -›@Aliabbas95*]] keyboard = {} keyboard.inline_keyboard = {{{text = '• مبرمج السورس •',url="t.me/Aliabbas95"}},}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Aliabbas95&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) return false end
---------------------------------------------------------------------------------------------------------
